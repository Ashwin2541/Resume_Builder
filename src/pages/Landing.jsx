        ...
        <div>
            <section
                style={{
                    height: "600px",
                    backgroundImage:
                        "url('https://i.pinimg.com/1200x/f0/23/63/f023637808953be97df5c8a2283ef6b9.jpg')",
            ...
            <section
                style={{
                    height: "500px",
                    backgroundImage:
                        "url('https://encrypted-tbn1.gstatic.com/images?q=tbn:ANd9GcT0RLlkb3_kaEeZBzTh6O4QKtiNuxw1dK5EFmV2FUe9Gd2ZKlCX')",
                    backgroundSize: "cover",
                    backgroundPosition: "center",
                    backgroundAttachment: "fixed",
                }}
